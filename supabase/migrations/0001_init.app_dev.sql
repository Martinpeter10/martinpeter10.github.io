...
--
-- THIS IS A TEMPLATE, NOT A RUNNABLE FILE. app_dev must be substituted.
...
grant all on all tables in schema app_dev to service_role;
grant all on all sequences in schema app_dev to service_role;
