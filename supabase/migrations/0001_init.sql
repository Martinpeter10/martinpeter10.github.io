...
-- Run once per schema:
--   prod project    -> public
--   nonprod project -> app_tst  and  app_dev
--
-- To target a non-public schema, run `set search_path = app_dev;` first, or
-- prefix the object names. Everything below is schema-relative on purpose.
--
