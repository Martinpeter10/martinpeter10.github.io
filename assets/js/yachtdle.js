// Yachtdle - one five-dice scorecard per day on DailyJamm.
...
(function () {
  ...
  function shareStats() {
    const s = loadStats();
    const avg = s.played ? Math.round(s.totalScore / s.played) : 0;
    const text = 'Yachtdle Stats\n' +
      'Played: ' + s.played + '\n' +
      'Best: ' + s.best + '  Avg: ' + avg + '\n' +
      'Streak: ' + s.curStreak + ' (best ' + s.bestStreak + ')\n' +
      'dailyjamm.com/yachtdle/';
